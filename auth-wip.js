...
//   this module cannot work over http://192.0.2.10:8080. Use the tunnel
//   (https://dev-host.example) or localhost. It says so explicitly
  ...
  function subtle() {
    if (!global.crypto || !global.crypto.subtle) {
      throw new Error(
        ...
        'be derived. Use https://dev-host.example rather than the LAN IP.'
      );
    }
